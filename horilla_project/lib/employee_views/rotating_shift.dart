...
class _WorkTypeRequestPageState extends State<RotatingShiftPage> {
  ...
  Future<void> getEmployees() async {
    ...
    // Clear previous employee data before starting a new fetch
    setState(() {
      employeeItems.clear();
      employeeIdMap.clear();
    ...
    // Iterate through pages starting from 1
    for (var page = 1;; page++) {
      ...
      if (response.statusCode == 200) {
        ...
        // If no employees on the current page, break the loop
        ...
        setState(() {
          for (var employee in employeeResults) {
            ...
            // Add to employee items and map
            employeeItems.add(fullName);
            employeeIdMap[fullName] = employeeId;
          }

          // Add employees to the allEmployeeList without overwriting
