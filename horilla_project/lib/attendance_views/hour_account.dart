...
class _HourAccountFormPageState extends State<HourAccountFormPage> {
  ...
  Future<void> userPermissionChecks() async {
    ...
    // Check add attendance overtime permission
    var addUri = Uri.parse('$typedServerUrl/api/base/check-user-level?employee_id=$employeeId&perm=attendance.add_attendanceovertime');
    ...
    // Check delete attendance overtime permission
    var deleteUri = Uri.parse('$typedServerUrl/api/base/check-user-level?employee_id=$employeeId&perm=attendance.delete_attendanceovertime');
    ...
    // Check change attendance overtime permission
    var changeUri = Uri.parse('$typedServerUrl/api/base/check-user-level?employee_id=$employeeId&perm=attendance.change_attendanceovertime');
  ...
  Future<void> getEmployees() async {
    ...
    for (var page = 1;; page++) {
      ...
      if (response.statusCode == 200) {
        ...
        // Break if there are no more employees in the current page
        ...
        setState(() {
          ...
          // Append current page employees to the allEmployeeList without clearing it
